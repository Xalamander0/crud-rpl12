                ...
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <form action="{{ route('posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="btn btn-md btn-primary"><i class="fa fa-plus-circle" aria-hidden="true"></i> UPDATE</button>
                            <button type="reset" class="btn btn-md btn-warning"><i class="fa fa-refresh" aria-hidden="true"></i> RESET</button>
                        </form>
                    </div>
                </div>
            </div>
